...
// 조회수 증가
    $update_query = "UPDATE userboardtable SET Board_view = Board_view + 1 WHERE Login_board_id='$pageid'  AND Board_category ='To-do'";
...
if (isset($_POST['submitlike']) && !isset($_SESSION["liked_$pageid"])) {
    $update_query = "UPDATE userboardtable SET Board_thumb = Board_thumb + 1 WHERE Login_board_id='$pageid'  AND Board_category ='To-do'";
    mysqli_query($db, $update_query) or die(mysqli_error($db));
...
<body>
    ...
    <div class="content-wrap">
        ...
        <div class="login-wrap">
            ...
            <?php
            // 좋아요 수 가져오기
            $query = "SELECT Board_thumb FROM userboardtable WHERE Login_board_id='$pageid' AND Board_category ='To-do'";
            $result = mysqli_query($db, $query);
